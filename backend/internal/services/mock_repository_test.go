...
func (m *MockTicketsRepo) Get(ctx context.Context, req *models.TicketFilter) ([]*models.Ticket, int, error) {
	args := m.Called(ctx, req)
...
func (m *MockGroupsRepo) GetMembers(ctx context.Context, req *models.GetGroupDTO) ([]*models.UserShort, error) {
	args := m.Called(ctx, req)
	return args.Get(0).([]*models.UserShort), args.Error(1)
}
func (m *MockGroupsRepo) GetMembersMap(ctx context.Context, groupIDs []uuid.UUID) (map[uuid.UUID][]*models.UserShort, error) {

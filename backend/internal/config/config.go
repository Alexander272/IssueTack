...
type (
	...
	TicketConfig struct {
		...
		// Расписание напоминаний исполнителям о приближении срока ("@hourly", "" — отключено)
		DeadlineSoonSchedule string `yaml:"deadline_soon_schedule" env:"TICKETS_DEADLINE_SOON_SCHEDULE" env-default:"@hourly"`
